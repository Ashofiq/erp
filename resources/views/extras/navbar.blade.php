...
@elseif(request()->is('hrpayroll*'))
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" href="{{ route('hrpayroll.dashboard') }}" >
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="5 12 3 12 12 3 21 12 19 12" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
            </span>
            <span class="nav-link-title">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('hrpayroll.department.index') }}" >
                    Department
                </a>
                <a class="dropdown-item" href="{{ route('hrpayroll.section.index') }}" >
                    Section
                </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('hrpayroll.employee.index') }}" >
            <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="5 12 3 12 12 3 21 12 19 12" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
            </span>
            <span class="nav-link-title">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('hrpayroll.leaveType.add') }}" >
                    Leave Type
                </a>

                <a class="dropdown-item" href="{{ route('hrpayroll.leaveType.index') }}" >
                    Mange Leave Type
                </a>
