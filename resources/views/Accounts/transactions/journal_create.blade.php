                ...
                <table class="table card-table  table-striped" id="accTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td width="15%">
                        <input class="form-control numeric changesDebit" type="text" name="dAmount[]" id="debit_1" placeholder="0.00">
                      </td>
                      <td width="15%">
                        <input class="form-control numeric changesCredit" type="text" name="cAmount[]" id="credit_1" placeholder="0.00">
                      </td>
