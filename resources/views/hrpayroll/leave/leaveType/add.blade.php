    ...
    <div class="page-body">
          <div class="container-xl">
            ...
            <div class="col-12">
                ...
                <form action="{{ route('hrpayroll.leaveType.create') }}" method="post" class="card">
                    @csrf
                        ...
                        <div class="row">
                          <div class="col-md-6 col-xl-12">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" name="name" placeholder="Input type name">
                                @error('name')
                ...
                <div class="card-footer text-end">
                  <div class="d-flex">
                    ...
                    <button type="submit" class="btn btn-primary ms-auto">Save Type</button>
                  </div>
                </div>
              </form>
            </div>
