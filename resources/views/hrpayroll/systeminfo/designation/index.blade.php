@extends('home')
@section('title', 'Designation | Hr Payroll')
                    ...
                    <tr>
                        ...
                        <td width="10%">
                          <ul class="list-group list-group-horizontal">
                            <li>
                              <form id="deleteChart_{{ $row->id }}" method="post" action="{{ route('hrpayroll.designation.delete') }}">
                                @csrf
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('hrpayroll.designation.create') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" name="description" placeholder="Designation description" required></textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary ms-auto" value="Save Designation">
          </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal modal-blur fade" id="edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('hrpayroll.designation.update') }}">
                @csrf
                ...
                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Designation description" required></textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary ms-auto" value="Update Designation">
