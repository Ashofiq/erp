@extends('home')
@section('title', 'Employee | Hr Payroll')
        ...
        <div class="page-header d-print-none">
            <div class="row g-2 align-items-center">
                ...
                <div class="btn-list">
                  ...
                  <a href="{{ route('hrpayroll.employee.add') }}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <tr>
                        ...
                        <td width="10%">
                          <ul class="list-group list-group-horizontal">
                            <li>
                              <form id="deleteChart_{{ $row->id }}" method="post" action="{{ route('hrpayroll.department.delete') }}">
                                @csrf
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('hrpayroll.department.create') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" name="description" placeholder="department description" required></textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary ms-auto" value="Save Department">
          </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal modal-blur fade" id="edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('hrpayroll.department.update') }}">
                @csrf
                ...
                <div class="mb-3">
                    <label class="form-label">Description</label>
                    <textarea type="text" class="form-control" id="description" name="description" placeholder="department description" required></textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-primary ms-auto" value="Update Department">
